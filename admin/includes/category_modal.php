<!-- Add -->
<div class="modal fade" id="addnew" style="background-image: linear-gradient(to right,rgba(175,228,247), rgba(186,223,3));">
...
<!-- Edit -->
<div class="modal fade" id="edit" style="background-image: linear-gradient(to right,rgba(175,228,247), rgba(186,223,3));">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<!-- Delete -->
<div class="modal fade" id="delete" style="background-image: linear-gradient(to right,rgba(175,228,247), rgba(186,223,3));">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
