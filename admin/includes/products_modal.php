            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <label for="photo" class="col-sm-1 control-label">Photo<br/>(Select Twice)</label>

                  <div class="col-sm-5">
                    <input type="file" id="photo" name="photo" accept=".jpg,.jpeg,.png">
                  </div> <br/><div class="col-sm-5">
                    <input type="file" id="photo" name="photo1" accept=".jpg,.jpeg,.png">
                  </div>
                </div>
                <p><b>Description</b></p>
                <div class="form-group">
